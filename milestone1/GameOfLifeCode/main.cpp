...
int main(int argc, char *argv[]){
    ...
    cout<<"Waehlen sie aus Aufgabe b oder e(Tippe b oder e ein)";
    cin>>task;
    if (task == "b"){ //Asking which Task
        ...
        if(state == 1){
            ...
            cin>>dir;
            cout << "Sie koennen durch jederzeitige Eingabe von 'evolution' das Spiel beginnen, durch die Eingabe 'end' das Spiel beenden";
            cout << endl << "und durch 'save' die aktuelle Matrix speichern.";
            ...
            cout << endl << "Sie koennen durch jederzeitige Eingabe von 'evolution' das Spiel beginnen, durch die Eingabe 'end' das Spiel beenden";
            cout << endl << "und durch 'save' die aktuelle Matrix speichern.";
            cout << endl << " -------------------------------------------------------------------------------------" << endl;
...
void interface_class(matrix old_matrix){
    ...
    if(usersChoice == "end"){
        ...
        cout << endl << "Matrix speichern?(yes oder no)";
        cin >> usersChoice;
        if (usersChoice == "yes"){
            cout << endl << "Bitte geben sie den Pfad ein :" << endl;
            cin >> dir;
            old_matrix.exportData(dir);
        }else{
            exit(0);
        }
    }else if (usersChoice == "save"){
        cout << endl << "Bitte geben sie den Pfad ein :" << endl;
        cin >> dir;
        old_matrix.exportData(dir);
        interface_class(old_matrix);
    }else if (usersChoice == "evolution"){
